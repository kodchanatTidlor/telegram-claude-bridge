...
from bridge import commands, cswap
...
async def _grab_screen(app, sid):
    """Read the visible text of a session's terminal via the iTerm2 API (no
    Screen Recording permission needed). Colors/graphics are lost — text only."""
