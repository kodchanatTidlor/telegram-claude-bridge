...
- **`/usage`** — quota % ของ **ทุก account** ที่ [`cswap`](https://github.com/) จัดการ: **5h** + **7d** (%, reset at, เหลืออีกเท่าไหร่) พร้อม emoji สีตาม severity (⚪️<5 🟢<50 🟡<70 🟠<90 🔴≥90). account ที่ active มี ✅. **ต้องติดตั้ง [`cswap`](https://github.com/) ก่อน** (requirement)
...
| `/usage` หรือ 📈 Usage | quota ทุก account จาก `cswap` (**required**): 5h/7d % + reset + severity ⚪️🟢🟡🟠🔴 (active มี ✅) |
