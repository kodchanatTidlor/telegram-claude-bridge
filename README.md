...
- **`/usage`** — token ที่ใช้ใน 5 ชม. ล่าสุด (จาก transcript เหมือน ccusage); ถ้าใส่ `CLAUDE_SESSION_KEY` _(optional)_ จะดึง quota % ทางการจาก claude.ai ได้
...
| `/usage` หรือ 📈 Usage | token 5 ชม. ล่าสุด (transcript); ใส่ `CLAUDE_SESSION_KEY` → quota % ทางการ |
