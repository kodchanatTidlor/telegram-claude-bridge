...
- **`/screen`** — แคปจอ session ปัจจุบันมาดูใน Telegram (เห็น TUI panel ของ Claude เช่น `/usage`, `/context` ที่ mirror ไม่ได้) — ลบเองเมื่อพิมพ์ข้อความถัดไป
...
มี reply keyboard ถาวรใต้ช่องพิมพ์: **`[📊 Status] [📸 Screen] [🛑 Stop]`**
